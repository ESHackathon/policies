...
This policy outlines ESH’s approach to authorship, data sharing, and dissemination of outputs resulting from Hackathon activities.
It aims to promote transparency, inclusivity, and recognition of all contributors.
...
-   ESH recognises the importance of inclusive authorship practices.
    All significant contributors—regardless of career stage—should be appropriately credited.
...
-   Projects developed during ESH events are typically co-produced by teams.
    Authorship should be based on contribution, not seniority.
