...
Complaints can be submitted by email to the conference organiser (neal.haddaway@sei.org), to the organiser's line manager at the Stockholm Environment Institute (fedra.vanhuyse@sei.org), to a member of the conference organising team (see https://www.eshackathon.org/events/2022-01-ESMARConf2022.html), or using this anonymous form: https://forms.gle/Q5SwsBJmnQevZAZp7.
